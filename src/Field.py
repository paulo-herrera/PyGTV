...
class CField:
    ...
    def __init__(self, field):
        ...
        """
        self._name = field[0]                      #0 : "Name"
        self._type = field[1]                      #1 : "Type"
        self._type_desc = FIELD_TYPE[self._type]   #Text description
        self._length = field[2]                    #2 : "Length"
        self._decimal_length = field[3]            #3 : "Decimal length"
